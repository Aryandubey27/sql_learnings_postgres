...
VALUES
    ...
    (24,  1, 2,   29.99, 1, '2024-01-05', '2024-01-09', '2023-01-05', 'pending',   'North'),
    (25,  2, 3,   49.99, 1, '2024-01-08', '2024-01-11', '2023-02-10', 'pending',   'South');
...
INSERT INTO transactions (customer_id, amount, transaction_date) VALUES
    ...
    (1,  200.00,  '2024-01-12 20:00:00'),
    (1,  350.00,  '2024-01-13 10:00:00'),
